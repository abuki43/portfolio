...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      image:ExitLogo,
      description:"Exit Exam studio is web app that provides past exit exam questions for Ethiopian universities students. It allows students to practice for their exams. Over 15000+ students have used the app to prepare for their exit exams.",
      technologies:["Nextjs"],
